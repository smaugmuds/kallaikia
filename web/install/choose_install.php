	 <form action='<?php echo $qsf->self; ?>' method='get'>
	  <div class='article'>
	   <div class='title'>Choose Installation Type:</div>
           ...
           <span class='form'>            
            This can be used to install a fresh copy of QSF Portal, either brand new or while wiping out a previous installation.
           </span>
           <p class='line'></p>

           <span class='field'><input id='upgrade' type='radio' name='mode' value='upgrade' /><label for='upgrade'>Upgrade Existing Site</label></span>
           <span class='form'>
            Used to upgrade an existing installation to the latest version of QSF Portal.
           </span>
           <p class='line'></p>
           ...
           <span class='form'>
            If you are running an existing forum, but wish to switch to QSF Portal while preserving your data, use this option.
           </span>
           <p class='line'></p>
